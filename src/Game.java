...
public class Game {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to my turn based strategy game\n\n" + // TODO come up with a better name
                ...
                "\t- Military Base: These are used to train the Military Units: Soldiers and Artillery. They can only train " +
                "one thing at a time, upgrading them strengthens the Units they train.\n\n" +
                "The Board:\n" +
                ...
                "\t- On your turn, you will be prompted to do certain actions like training Units, attacking with them, or " +
